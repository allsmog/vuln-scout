...
| Kuzushi/NPM integration | Stable | ESM package entrypoint, 14 exposed tools, package contents allowlist | Kuzushi runtime behavior still needs consumer-side integration coverage |
