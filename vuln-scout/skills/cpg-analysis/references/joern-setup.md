...
```bash
# Check Joern CLI without entering the REPL
joern --help
...
| C# | csharpsrc2cpg | Experimental |
| Kotlin | kotlin2cpg | Good |

Solidity is not a Joern CPG target in VulnScout. Use Slither for Solidity smart-contract analysis.
