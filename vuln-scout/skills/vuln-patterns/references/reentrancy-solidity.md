...
Solidity verification is Slither-owned in VulnScout. Joern CPG verification returns `na_cpg` for Solidity findings rather than claiming Solidity frontend support.
